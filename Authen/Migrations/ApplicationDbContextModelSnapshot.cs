...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthoEx.Models.Exam", b =>
                {
            ...
            modelBuilder.Entity("AuthoEx.Models.Student", b =>
                {
                    b.Property<long>("StudentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Authen.Models.Subject", b =>
                {
                    b.Property<int>("SubjectId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AuthoEx.Models.Exam", b =>
                {
                    b.HasOne("AuthoEx.Models.Student", "Student")
                        .WithMany("Exams")
                        .HasForeignKey("StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AuthoEx.Models.Subject", "Subject")
                        .WithMany("Exams")
            ...
            modelBuilder.Entity("Authen.Models.Student", b =>
                {
                    b.Navigation("Exams");
                });
